...
import sys
sys.path.insert(0, "/teamspace/studios/this_studio/Magicface/MagicFace")

# Create torch._vendor module before any other imports
import types
try:
    import torch
    if not hasattr(torch, '_vendor'):
        # Create a dummy _vendor module
        ...
        # Add to sys.modules to ensure it can be imported
...
# Patch xformers compatibility
try:
    import torch
    # Add the missing attribute to torch.backends.cuda
...
# Patch huggingface_hub before any other imports
try:
